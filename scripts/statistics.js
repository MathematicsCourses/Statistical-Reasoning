/*
    ...
    https://statistical-reasoning.appspot.com/GradesCalculators.html
*/
...
function gradeMLS(event) {
    ...
    var weightOneOne = parseFloat(document.getElementById("weightOneOne").value, 10) || 0,
        ...
        weightTwoOneTwoTwo1st =+ parseFloat(document.getElementById("weightTwoOneTwoTwo1st").value, 10) || 0,
        scoreTwoOneTwoTwo1st =+ parseFloat(document.getElementById("scoreTwoOneTwoTwo1st").value, 10) || 0,
        weightedScoreTwoOneTwoTwo1st,

        weightTwoOneTwoTwo2nd =+ parseFloat(document.getElementById("weightTwoOneTwoTwo2nd").value, 10) || 0,
        scoreTwoOneTwoTwo2nd =+ parseFloat(document.getElementById("scoreTwoOneTwoTwo2nd").value, 10) || 0,
        weightedScoreTwoOneTwoTwo2nd,

        weightTwoThreeTwoFour =+ parseFloat(document.getElementById("weightTwoThreeTwoFour").value, 10) || 0,
        scoreTwoThreeTwoFour =+ parseFloat(document.getElementById("scoreTwoThreeTwoFour").value, 10) || 0,
        ...
        sumWeightsMLS = 
        weightOneOne + weightOneTwo + weightOneThree + weightOneFour + weightOneFive 
        + weightTwoOneTwoTwo1st + weightTwoOneTwoTwo2nd + weightTwoThreeTwoFour + weightTwoFive 
        + weightThreeOne1st + weightThreeOne2nd + weightThreeTwo + weightThreeThree + weightThreeFour + weightThreeFive 
        + weightFourOne + weightFourTwo + weightFourThree + weightFourFour 
        + weightFiveOne + weightFiveTwo1st + weightFiveTwo2nd + weightFiveThree + weightFiveFour
        + weightSixOne + weightSixTwo1st + weightSixTwo2nd
        + weightSevenOne1st + weightSevenOne2nd + weightSevenTwo + weightSevenThree + weightSevenFour
        + weightEightOne + weightEightTwo + weightEightThree
        + weightNineOne + weightNineTwo + weightNineThree + weightNineFour
        + weightTenOne + weightTenTwo
        ;

        document.getElementById("sumWeightsMLS").value = sumWeightsMLS;
        
        sumWeightedScoresMLS = 
        weightedScoreOneOne + weightedScoreOneTwo + weightedScoreOneThree + weightedScoreOneFour + weightedScoreOneFive 
        + weightedScoreTwoOneTwoTwo1st + weightedScoreTwoOneTwoTwo2nd + weightedScoreTwoThreeTwoFour + weightedScoreTwoFive 
        + weightedScoreThreeOne1st + weightedScoreThreeOne2nd + weightedScoreThreeTwo + weightedScoreThreeThree + weightedScoreThreeFour + weightedScoreThreeFive
        + weightedScoreFourOne + weightedScoreFourTwo + weightedScoreFourThree + weightedScoreFourFour
        + weightedScoreFiveOne + weightedScoreFiveTwo1st + weightedScoreFiveTwo2nd + weightedScoreFiveThree + weightedScoreFiveFour
        + weightedScoreSixOne + weightedScoreSixTwo1st + weightedScoreSixTwo2nd
        + weightedScoreSevenOne1st + weightedScoreSevenOne2nd + weightedScoreSevenTwo + weightedScoreSevenThree + weightedScoreSevenFour
        + weightedScoreEightOne + weightedScoreEightTwo + weightedScoreEightThree
        + weightedScoreNineOne + weightedScoreNineTwo + weightedScoreNineThree + weightedScoreNineFour
        + weightedScoreTenOne + weightedScoreTenTwo
        ;
...
function gradeCourse(event) {
    ...
    var weightMLS = parseFloat(document.getElementById("weightMLS").value, 10) || 0,
        ...
        sumWeightedScoresCourse = 
        weightedScoreMLS 
        + weightedScoreTest1 + weightedScoreTest2 + weightedScoreTest3
        + weightedScoreProject
        + weightedScoreFinalExam
        ;
